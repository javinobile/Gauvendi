...
import { RoomProductDailyAvailability } from './room-product-daily-availability.entity';
...
import { RoomProductRestrictionAutomateSetting } from './room-product-restriction-automate-setting.entity';
...
export class RoomProduct extends BaseEntityWithTranslationsDeleted {
  ...
  @OneToOne(
    () => RoomProductRestrictionAutomateSetting,
    (roomProductRestrictionAutomateSetting) => roomProductRestrictionAutomateSetting.roomProduct,
    { onDelete: 'CASCADE' }
  )
  roomProductRestrictionAutomateSetting: RoomProductRestrictionAutomateSetting;
  ...
  @JoinColumn({ name: 'id', referencedColumnName: 'roomProductId' })
