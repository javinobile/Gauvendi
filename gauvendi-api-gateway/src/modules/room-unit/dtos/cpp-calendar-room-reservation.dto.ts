...
import { ReservationStatusEnum } from "@src/core/enums/common.enum";
import { ReservationRoomDto } from "@src/modules/reservation/reservation.dto";
...
export interface CppCalendarReservationDto {
  ...
  proposalSetting?: BookingProposalSettingDto;
...
export class CppCalendarRoomReservationFilterDto {
  @IsString()
  @IsNotEmpty()
  hotelId: string;
  @IsDateString()
