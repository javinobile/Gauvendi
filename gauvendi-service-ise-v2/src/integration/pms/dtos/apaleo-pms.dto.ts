...
export enum ApaleoGuaranteeType {
  PREPAYMENT = 'Prepayment', // Yêu cầu thanh toán trước
  CREDIT_CARD = 'CreditCard', // Cần thẻ tín dụng để đảm bảo
  COMPANY = 'Company', // Được đảm bảo bởi công ty
  NONE = 'None' // Không có đảm bảo
}

export const ApaleoGuaranteeTypeMapping = {
  [HotelPaymentModeCodeEnum.GUAWCC]: ApaleoGuaranteeType.CREDIT_CARD,
  [HotelPaymentModeCodeEnum.NOGUAR]: ApaleoGuaranteeType.NONE,
  [HotelPaymentModeCodeEnum.GUAWDE]: ApaleoGuaranteeType.PREPAYMENT,
  [HotelPaymentModeCodeEnum.GUAINV]: ApaleoGuaranteeType.COMPANY
};
