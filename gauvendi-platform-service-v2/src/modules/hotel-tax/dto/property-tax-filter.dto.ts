...
export class PropertyTaxFilterDto extends Filter {
  @IsString()
  @IsNotEmpty()
  @ApiPropertyOptional({
  ...
  // @IsEnum(PropertyTaxType, { each: true })
  @IsOptional()
  @ApiPropertyOptional({
    description: 'Set of property tax types',
    enum: PropertyTaxType,
    isArray: true,
    example: [PropertyTaxType.CITY_TAX, PropertyTaxType.TOURIST_TAX]
  })
  @OptionalArrayProperty()
  typeList?: string[];
}
