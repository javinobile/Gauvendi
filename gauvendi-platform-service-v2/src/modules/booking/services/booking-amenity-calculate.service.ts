...
import { RoundingModeEnum, SellingTypeEnum } from 'src/core/enums/common';
import { DecimalRoundingHelper } from 'src/core/helper/decimal-rounding.helper';
import { S3Service } from 'src/core/s3/s3.service';
import { AmenityPricingDto, ReservationAmenityComboItemPricingDto, ReservationAmenityPricingDateDto } from '../dtos/booking.dto';
...
import { CalculatePricingAmenityPayload } from '@src/modules/hotel/dtos/calculate-pricing-amenity-payload.dto';
  ...
  private async remoteCalculatePricingAmenity(
    ...
    try {
      return await this.calculateAmenityPricingService.calculatePricingAmenity(
        params.input,
        params.hotelConfigRoundingMode
      );
    } catch (error) {
