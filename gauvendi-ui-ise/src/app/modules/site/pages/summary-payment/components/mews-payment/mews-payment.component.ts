...
@Component({
  ...
  templateUrl: './mews-payment.component.html',
  styleUrls: ['./mews-payment.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MewsPaymentComponent extends AbstractPaymentMethodComponent {
