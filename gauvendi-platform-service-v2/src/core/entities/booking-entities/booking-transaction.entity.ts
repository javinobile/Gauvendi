...
import { GlobalPaymentMethod } from '../hotel-entities/global-payment-method.entity';
...
export class BookingTransaction extends BaseEntityWithDeleted {
  ...
  @Column('varchar', { name: 'payment_mode', nullable: true })
  ...
  @ManyToOne(
    () => GlobalPaymentMethod,
    (globalPaymentMethod) => globalPaymentMethod.bookingTransactions
  )
