...
export class RoomProductPricingMethodDetail extends BaseEntity {
  ...
  @NumericColumn({
    name: 'pricing_method_adjustment_value',
    precision: 26,
    scale: 4,
    nullable: true
  })
  ...
  @Column({ type: 'text', name: 'mapping_room_product_id', nullable: true })
  ...
  @ManyToOne(() => RoomProduct, (roomProduct) => roomProduct.roomProductPricingMethodDetails)
  @JoinColumn({ name: 'target_room_product_id' })
  targetRoomProduct: RoomProduct;
}
