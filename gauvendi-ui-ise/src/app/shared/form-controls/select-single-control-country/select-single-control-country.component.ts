...
@Component({
  selector: 'app-select-single-control-country',
  standalone: true,
  imports: [CommonModule, FilterDropdownPipe, MatOptionModule, MatSelectModule, MatIconModule],
  templateUrl: './select-single-control-country.component.html',
  styleUrls: ['./select-single-control-country.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      multi: true,
      useExisting: forwardRef(() => SelectSingleControlCountryComponent),
    },
  ],
})
export class SelectSingleControlCountryComponent implements ControlValueAccessor, OnChanges {
