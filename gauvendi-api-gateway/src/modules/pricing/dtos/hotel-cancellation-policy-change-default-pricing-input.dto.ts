...
import { CancellationFeeUnitEnum, CancellationPolicyDisplayUnitEnum } from '@src/core/enums/common.enum';
import { IsEnum, IsNotEmpty, IsNumber, IsOptional, IsString, IsUUID, Min } from 'class-validator';


export class HotelCancellationPolicyChangeDefaultPricingInputDto {
  @IsString()
  @IsNotEmpty()
  @ApiPropertyOptional({
