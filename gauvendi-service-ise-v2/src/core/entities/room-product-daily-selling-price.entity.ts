...
export class RoomProductDailySellingPrice extends BaseEntity {
  ...
  @NumericColumn({ name: 'feature_adjustments', precision: 26, scale: 4, nullable: false, default: 0 })
  featureAdjustments: number;

  @NumericColumn({ name: 'rate_plan_adjustments', precision: 26, scale: 4, nullable: false, default: 0 })
