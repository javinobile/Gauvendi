...
import { CurrencyRate } from '../core-entities/currency-rate.entity';
import { Brand } from './brand.entity';
import { HotelPaymentMode } from './hotel-payment-mode.entity';
...
export class Hotel extends BaseEntityWithDeleted {
  ...
  @ManyToOne(() => FileLibrary, { nullable: true, eager: false })
  @JoinColumn({ name: 'background_category_image_id' })
  backgroundCategoryImage: FileLibrary;

  @ManyToOne(() => FileLibrary, { nullable: true, eager: false })
  @JoinColumn({ name: 'custom_theme_image_id' })
  customThemeImage: FileLibrary;

  @ManyToOne(() => FileLibrary, { nullable: true, eager: false })
  @JoinColumn({ name: 'lowest_price_image_id' })
  lowestPriceImage: FileLibrary;

  @ManyToOne(() => FileLibrary, { nullable: true, eager: false })
  @JoinColumn({ name: 'stay_option_background_image_id' })
  stayOptionBackgroundImage: FileLibrary;

  @ManyToOne(() => FileLibrary, { nullable: true, eager: false })
  @JoinColumn({ name: 'customize_stay_option_background_image_id' })
  customizeStayOptionBackgroundImage: FileLibrary;

  @ManyToOne(() => FileLibrary, { nullable: true, eager: false })
  @JoinColumn({ name: 'stay_option_suggestion_image_id' })
  stayOptionSuggestionImage: FileLibrary;

  @ManyToOne(() => FileLibrary, { nullable: true, eager: false })
  @JoinColumn({ name: 'signature_background_image_id' })
  signatureBackgroundImage: FileLibrary;

  @ManyToOne(() => Brand, { nullable: true, eager: false })
  @JoinColumn({ name: 'brand_id' })
  brand: Brand;

  @OneToMany(() => HotelPaymentMode, (hotelPaymentMode) => hotelPaymentMode.hotel)
  paymentModes: HotelPaymentMode[];
}
