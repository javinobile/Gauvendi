...
import { finalize, lastValueFrom, noop } from 'rxjs';

@Component({
  selector: 'app-proposal-onepay',
  standalone: true,
  imports: [
    CommonModule,
  ...
  templateUrl: './proposal-onepay.component.html',
  styleUrl: './proposal-onepay.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ProposalOnepayComponent extends AbstractPaymentMethodComponent {
