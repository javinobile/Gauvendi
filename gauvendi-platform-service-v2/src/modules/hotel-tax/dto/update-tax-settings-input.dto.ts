...
import { UpdateTaxSettingsItemInputDto } from './update-tax-settings-item-input.dto';

export class UpdateTaxSettingsInputDto {
  @IsString()
  @IsNotEmpty()
  @ApiProperty({
  ...
  @Type(() => UpdateTaxSettingsItemInputDto)
  @ApiPropertyOptional({
  ...
  itemList?: UpdateTaxSettingsItemInputDto[];
}
