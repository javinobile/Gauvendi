...
@Component({
  ...
  templateUrl: './proposal-no-opi.component.html',
  styleUrls: ['./proposal-no-opi.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ProposalNoOpiComponent extends AbstractPaymentMethodComponent {
